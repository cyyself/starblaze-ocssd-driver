...
struct nvm_rq {
	...
	u64 ppa_status; /* TODO: ppa media status,现在不支持返回ppa读写状态 */
	int error;
...
extern void *pblk_dev_dma_alloc(struct nvm_dev *, gfp_t, dma_addr_t *);
extern void pblk_dev_dma_free(struct nvm_dev *, void *, dma_addr_t);

extern struct nvm_dev *nvm_alloc_dev(int);
extern int pblk_nvm_register(struct nvm_dev *);
extern void pblk_nvm_unregister(struct nvm_dev *);
...
extern int nvm_set_tgt_bb_tbl(struct nvm_tgt_dev *, struct ppa_addr *,
			      int, int);//
extern int nvm_raw_submit_io(struct nvm_tgt_dev *, struct nvm_rq *);
extern int nvm_submit_io_sync(struct nvm_tgt_dev *, struct nvm_rq *);//
extern void pblk_end_io(struct nvm_rq *);
...
static inline int pblk_nvm_register(struct nvm_dev *dev)
{
	return -EINVAL;
}
static inline void pblk_nvm_unregister(struct nvm_dev *dev) {}
#endif /* CONFIG_NVM */
#endif /* LIGHTNVM.H */
